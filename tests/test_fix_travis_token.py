...
class Fix:
    ...
    def get_final_token(self):
        try:
            ...
            return pypy_stages[0]["deploy"]["password"]["secure"]
...
def _test_fix_travis___after_travis_cli_modified(project_dir):
    ...
    assert after_travis_cli_modified.get_final_token() == "NEW_PYPI_TOKEN"
...
def _test_fix_travis___after_travis_cli_unmodified(project_dir):
    ...
    assert after_travis_cli_unmodified.get_final_token() == "NEW_PYPI_TOKEN"
